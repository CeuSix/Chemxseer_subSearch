...
/**
 * This is a self implementation of the min heap
 * We provide two operations: insert and deletemin
 * This code is extended 
 * from http://www.cs.usfca.edu/~galles/cs245/lecture/MinHeap.java.html
 * @author dayuyuan
 *
 * @param <Value>
 */
...
public class MinHeapInteger{
	...
	public boolean updateKey(int v, int newKey){
		// First step: find the position of the entry with value = v, worst case O(n)
		int index = -1;
		for(int i = 1; i<= size; i++)
			if(values[i] == v){
				index = i;
