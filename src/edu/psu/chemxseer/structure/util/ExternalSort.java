...
public class ExternalSort {
	 ...
	 */
	public static List<File> sortInBatch(File file, Comparator<String> cmp, boolean containHeader, String[] header
			) throws IOException {
	 ...
	 */
	public static int mergeSortedFiles(List<File> files, BufferedWriter fbw, final Comparator<String> cmp) throws IOException {
