...
/**
 * A converter between byte[] to numeric number, such as Long type, Integer type and short type
 * @author dayuyuan
 *
 */
...
//	 */
	public static String int2String(int number){
		...
		result.getChars(0, result.length(), testChar, 0);
		int testNumber = char2Int(testChar);
