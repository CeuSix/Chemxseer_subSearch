...
/**
 * FastSUStateExt is a Extension of FastSUState
 * It support change of the smaller graph
 * Given a FastSUStateExt isomorphism between the small graph and the large graph
 * In addition, given a middle graph in extension representation of the smaller graph
 * The FastSUStateExt can change to an isomorphism between the middle graph and the large graph
 * @author dayuyuan
 *
 */
