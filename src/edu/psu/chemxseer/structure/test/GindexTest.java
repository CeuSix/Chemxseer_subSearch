...
public class GindexTest {
	public static void main(String[] args) throws IOException, ParseException{
		...
		BasicExpBuilder builder = new BasicExpBuilder(dbName, MyFactory.getSmilesParser(), baseName);
		SubgraphSearch searcher = builder.buildGIndexDF(0.1, 0);
		
		PostingFeatures queries = FeatureProcessorG.frequentSubgraphMining(dbName, dbName + "patterns", dbName + "postings",
				0.05, 2, 30, MyFactory.getSmilesParser());
