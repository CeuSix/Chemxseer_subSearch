...
//		
//		//FeatureProcessorL.frequentSubgraphMining(dbName, featureFileName, postingFileName, minimumFrequency, 10, MyFactory.getSmilesParser());
//		NoPostingFeatures<OneFeatureImpl> features = new NoPostingFeatures<OneFeatureImpl>(featureFileName, MyFactory.getFeatureFactory(FeatureFactory.OneFeature));
//		PostingFeatures postingFeatures = new PostingFeatures(postingFileName, features);
...
//		String postingFileName = "/Users/dayuyuan/Documents/workspace/Experiment1/postings";
//		NoPostingFeatures<OneFeatureImpl> features = new NoPostingFeatures<OneFeatureImpl>(featureFileName, MyFactory.getFeatureFactory(FeatureFactory.OneFeature));
//		NoPostingFeatures_Ext<OneFeatureImpl> advFeatures = new NoPostingFeatures_Ext<OneFeatureImpl>(features);
...
//		String dbName = "/Users/dayuyuan/Documents/workspace/Experiment1/graphDataSelected";
//		String dbName2 = "/Users/dayuyuan/Documents/workspace/Experiment1/graphDataConnected";
...
//		}
////		featureProcessor.mergeGraphFile(dbName, dbName2, mergedFileName, classFileName);
////		featureProcessor.frequentSubgraphMining(mergedFileName, classFileName, featureFileName, 
