...
/**
 * Edited by Dayu Yuan
 * DayuYuan: All Distinct Edges are Returned (both frequent & infrequent), All Edge-0 nodes are pruned, 
 * all frequent subgraphs are returned
 * 
...
public class GSpanMiner_Edge extends AbstractMiner {
	...
	private static PostingFeatures getFeatures(GSpanMiner_Edge m, Settings s, String featureFileName, String postingFileName) 
	throws IOException{
