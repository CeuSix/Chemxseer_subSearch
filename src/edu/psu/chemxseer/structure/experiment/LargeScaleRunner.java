...
import edu.psu.chemxseer.structure.setcover.experiments.SubgraphSearchExp;
...
//			GraphDatabase_OnDisk gDB = new GraphDatabase_OnDisk(dbFileName, MyFactory.getSmilesParser());
...
//				gIndex.loadIndex(baseName+"GindexDF/", SubgraphSearch_Gindex.getIndexName());
//				MemoryConsumptionCal.runGC();
...
//				in_memoryIndex.loadIndex(baseName+"LindexDF/", SubgraphSearch_Lindex.getIndexName());
//				MemoryConsumptionCal.runGC();
//				long end =rc.freeMemory();;
//				System.out.println(start-end);
//				MemoryConsumptionCal.runGC();
...
//				long start = rc.freeMemory();;
//				LindexConstructor in_memoryIndex = new LindexConstructor();
//				in_memoryIndex.loadIndex(baseName+ "LindexTCFG/", SubgraphSearch_LindexPlus.getIn_MemoryIndexName());
//				MemoryConsumptionCal.runGC();
//				long end = rc.freeMemory();;
//				System.out.println(start-end);
//				MemoryConsumptionCal.runGC();
...
//	}
	public static void main(String[] args) throws IOException, ParseException{
		...
		for(int i = 16; i <= 20; i++){
			String baseName = "/home/duy113/Experiment/LindexJournal/LargeScale/Gindex_Rebuild/" + i + "/";
			String dbFileName = "/home/duy113/Experiment/LindexJournal/LargeScale/G" +i + "/GraphDB" + i;
			GraphParser dbParser = MyFactory.getSmilesParser();
			GraphDatabase_OnDisk gDB = new GraphDatabase_OnDisk(dbFileName, MyFactory.getSmilesParser());
			System.out.println(i);
...
//				long start = rc.freeMemory();
//				GindexConstructor gIndex = new GindexConstructor(false);
//				gIndex.loadIndex(baseName+"GindexDF" + flag+ "/", SubgraphSearch_Gindex.getIndexName());
//				MemoryConsumptionCal.runGC();
//				long end = rc.freeMemory();;
//				System.out.println(start-end);
//				MemoryConsumptionCal.runGC();
...
//				long start = rc.freeMemory();
//				LindexConstructor in_memoryIndex  = new LindexConstructor();
//				in_memoryIndex.loadIndex(baseName+"LindexDF" + flag + "/", SubgraphSearch_Lindex.getIndexName());
//				MemoryConsumptionCal.runGC();
//				long end =rc.freeMemory();;
//				System.out.println(start-end);
//				MemoryConsumptionCal.runGC();
...
//				long start = rc.freeMemory();;
//				FGindexConstructor fgIndexSearcher = new FGindexConstructor(gDB);
//				fgIndexSearcher.loadIndex(baseName + "FGindex" + flag + "/", SubgraphSearch_FGindex.getIn_MemoryIndexName());
//				MemoryConsumptionCal.runGC();
//				long end =rc.freeMemory();
//				System.out.println(start-end);
//				MemoryConsumptionCal.runGC();
...
//				long start = rc.freeMemory();;
//				LindexConstructor in_memoryIndex = new LindexConstructor();
//				in_memoryIndex.loadIndex(baseName+ "LindexTCFG" + flag + "/", SubgraphSearch_LindexPlus.getIn_MemoryIndexName());
//				MemoryConsumptionCal.runGC();
//				long end = rc.freeMemory();;
//				System.out.println(start-end);
//				MemoryConsumptionCal.runGC();
