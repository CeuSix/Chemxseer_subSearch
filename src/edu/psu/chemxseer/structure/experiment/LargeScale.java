...
public class LargeScale{
	/**
	 * Problem of Gindex 0.1: to few frequent features are selected {especially the ">4 frequent features"}
	 * Problem of FGindex 0.03: too few frequent features are selected
	 * @param args
	 * @throws IOException
	...
	public static void main2(String[] args) throws IOException, ParseException{
		for(int i = 17; i< 18; i++){
			...
			BasicExpBuilder exp = new BasicExpBuilder(dbFileName, gParser, baseName);

			System.out.println("Build Gindex with max-min Support: 0.06: Flag 2");
			exp.buildGIndexDF(0.06, 2);
//			exp.buildLindexDF(2);
			System.out.println("Build Gindex with max-min Support: 0.03: Flag 3");
...
//			exp.buildLindexAdvTCFG(3);
			...
			System.out.println("Build Gindex with max-min Support: 0.02: Flag 4");
			exp.buildGIndexDF(0.02, 4);
//			exp.buildLindexDF(4);
			System.out.println("Build Gindex with max-min Support: 0.01: Flag 5");
