...
//	public LargeScale2(String dbFileName,GraphParser dbParser, String baseName, String featureBaseName) {
...
//		LargeScale2 exp = new LargeScale2(dbFileName, dbParser, baseName, featureFileBaseName);
//		
//		exp.buildGIndexDF();
//		exp.buildLindexDF();
//		exp.buildFGindex();
...
//		PostingFeatures oriFeatures = new PostingFeatures(featureBaseName + "GindexDF/GPatterns", featureBaseName + "GindexDF/GPostings");
//		oriFeatures.loadFeatures();
//		
//		NoPostingFeatures_Ext features = new NoPostingFeatures_Ext(FeatureProcessorL.mergeFeatures(oriFeatures, edgeFeatures));
//
//		//2. Build Index
//		SubgraphSearch_GindexBuilder builder = new SubgraphSearch_GindexBuilder();
//		builder.buildIndexWithoutFeatureSelection(features, new GraphDatabase_OnDisk(this.dbFileName, dbParser), false, temp, dbParser);
//	}
//	
//	public void buildLindexDF() throws CorruptIndexException, LockObtainFailedException, IOException, ParseException{
//		//0. Create Folder
...
//		FGFeatures candidateFeatures = new FGFeatures(featureBaseName + "FGindex/patterns", featureBaseName + "FGindex/postings");
...
//		builder.buildIndex(candidateFeatures , new GraphDatabase_OnDisk(dbFileName, dbParser), temp, dbParser);
//	}
//	
...
//		PostingFeatures edgeFeatures = FeatureProcessorL.findEdgeOneFeatures(dbFileName, temp+"edge", temp+"edgePosting", dbParser);
//		PostingFeatures subgraphFeatures = new PostingFeatures(featureBaseName + "FGindex/patterns", featureBaseName + "FGindex/postings");
...
//		NoPostingFeatures_Ext onDiskFeatures = new NoPostingFeatures_Ext(features.getUnSelectedFeatures(null, null, false));
