...
import edu.psu.chemxseer.structure.iterative.FeatureGenerator.FeatureFinder;
import edu.psu.chemxseer.structure.iterative.FeatureGenerator.TestingQueries;
import edu.psu.chemxseer.structure.iterative.LindexUpdate.SubgraphSearch_LindexUpdate;
import edu.psu.chemxseer.structure.iterative.LindexUpdate.SubgraphSearch_LindexupdateBuilder;
...
//	protected double gamma; // the parameter finding the lower bound of the objective function
//	protected double alpha; // the parameter for the combination of the lower bound and upper bound
//	
//	
...
//		
//		IterativeFeatureMining exp = new IterativeFeatureMining(dbFileName, dbParser, baseName);
...
//	}
//	
//	public IterativeFeatureMining(String dbFileName, GraphParser dbParser, String baseName){
...
//	 */
//	public void buildOldIndex(GraphDatabase_OnDisk gDB) throws IOException, ParseException, MathException{
//		BasicExpBuilder builder = new BasicExpBuilder(dbFileName, dbParser, baseName + "1/");
...
//		InFrequentQueryGenerater gen = new InFrequentQueryGenerater(baseName + "1/TrainQueryRaw");
//		gen.generateInFrequentQueriesUniform2(4, 20, 10000, gDB, fgIndex.getEdgeIndex());
//		
...
//	}
//	
//	private SubgraphSearch_LindexUpdate loadIndex(int i, String theBaseName) throws IOException{
//		GraphDatabase_OnDisk gDB = new GraphDatabase_OnDisk(dbFileName, dbParser);
//		SubgraphSearch_Lindex searcher = null;
//		SubgraphSearch_LindexBuilder Lbuilder = new SubgraphSearch_LindexBuilder();
//
//		switch(i){
//		case 1:
...
//		HashMap<Graph, Integer> qMaps = DFQueries.loadQueriesRaw(baseName + "1/TrainQueryRaw");
//		DFQueries.gapsFiltering(qMaps, lindex, baseName + "1/DFTrainQuery", false);
//		ArrayList<TestQuery> testQueries = DFQueries.loadQueries(baseName + "1/DFTrainQuery");
//		
//		FeatureFinder fFinder = new FeatureFinder(lindex, testQueries, minFreq, true, gamma, alpha);
//		for(int w = 1; w< 4; w++){
...
//			//1. Save the Index
//			SubgraphSearch_LindexupdateBuilder builder = new SubgraphSearch_LindexupdateBuilder();
...
//		TestingQueries DFQueries = new TestingQueries();
//		HashMap<Graph, Integer> qMaps = DFQueries.loadQueriesRaw(baseName + "1/TrainQueryRaw");
//		DFQueries.gapsFiltering(qMaps, lindex, baseName + "1/TCFGTrainQuery", false);
//		ArrayList<TestQuery> testQueries = DFQueries.loadQueries(baseName + "1/TCFGTrainQuery");
//		
//		FeatureFinder fFinder = new FeatureFinder(lindex, testQueries, minFreq, true, gamma, alpha);
//		for(int w = 1; w< 4; w++){
//			long[] time = new long[1];
