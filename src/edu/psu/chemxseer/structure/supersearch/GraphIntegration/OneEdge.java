...
public class OneEdge {
	 ...
	 * @param edgeLabel
	 */
	public OneEdge(int nodeA, int nodeB, int edge, int nodeALabel, int nodeBLabel, int edgeLabel){
		this.nodeAID = nodeA;
		this.nodeBID = nodeB;
	...
	public boolean equals(OneEdge aEdge){
		...
		if(nodeALabel == aEdge.nodeALabel && nodeBLabel == aEdge.nodeBLabel)
			return true;
		else if(nodeALabel == aEdge.nodeBLabel && nodeBLabel == aEdge.nodeALabel)
			return true;
		else return false;
	...
	/**
	 * @param nodeBID the nodeBID to set
	 */
	...
	/**
	 * @param nodeALabel the nodeALabel to set
	 */
	...
	/**
	 * @param nodeBLabel the nodeBLabel to set
	 */
