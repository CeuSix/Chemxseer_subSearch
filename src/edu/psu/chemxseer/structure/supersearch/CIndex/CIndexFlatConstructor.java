...
public class CIndexFlatConstructor{
	 ...
	 */
	public static CIndexFlat construct (NoPostingFeatures selectedFeatures){
	 ...
	 * @throws IOException
	 */
	public static CIndexFlat loadSearcher(String baseName, String indexFileName) throws IOException{
		BufferedReader reader  = new BufferedReader(new FileReader(baseName + indexFileName));
		...
		for(int i = 0; i< featureSize; i++){
			...
			if(temp==null)
				System.out.println("Exception in CIndexFlat(String)"); // For test only
	 ...
	 * @throws IOException
	 */
	public static void saveSearcher(CIndexFlat searcher, String baseName, String indexFileName) throws IOException{
		BufferedWriter writer = new BufferedWriter(new FileWriter(new File(baseName, indexFileName)));
