...
public class PrefixIndexSearcherConstructor {
	 ...
	 * @param features
	 */
	public static PrefixIndexSearcher construct(NoPostingFeatures inputFeatures){
		PrefixFeature[] features = new PrefixFeature[inputFeatures.getfeatureNum()];
		for(int i = 0; i< features.length; i++){
			features[i]= new PrefixFeature(i, inputFeatures.getFeature(i).getDFSCode(),null);
		}
		return new PrefixIndexSearcher(features);
	}
	/**
	 * Given the features, and the UpperLevel Index (the prefix), construct
	 * the nextLevel PrefixIndexSearcher:
	 * Prefix labeling
	 * @param inputFeatures
	 ...
	 */
	public static PrefixIndexSearcher loadSearcher(String baseName, String indexName, PrefixIndexSearcher upperLevelIndex) 
	 ...
	 * @throws IOException
	 */
	public static void saveSearcher(PrefixIndexSearcher searcher, String baseName, String indexName) throws IOException{
		//1. Num of features
