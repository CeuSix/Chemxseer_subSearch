...
/**
 * One Wrapper Class of the IndexSearcherPrefix: 
 * Since the concept of the GPTreeSearcher is greatlly similar to that of PrefixIndex
 * @author dayuyuan
 *
 */
public class GPTreeSearcher implements IndexSearcherPrefix{
