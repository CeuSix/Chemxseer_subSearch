...
public class OneFeatureMultiClass implements IOneFeature, Serializable{
	...
	/**
	 * 
	 * @param ID = -1 then use the default index loaded from the disk
	...
	public static class Factory extends FeatureFactory{
		...
		@Override
		public OneFeatureMultiClass genOneFeature(int id,
	...
	public OneFeatureImpl toFeatureImpl() {
		return new OneFeatureImpl(label, this.frequency[0], this.shift[0],id, selected);
	}
}
