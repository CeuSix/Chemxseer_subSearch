...
public class GraphResultNormalPrefix extends GraphResultNormal implements GraphResultPref{
	
	private int prefixID;
	private int[][] suffix;
	/**
	 * Currently support DFS parser only
	 * Prefix + Suffix
	 * If the prefixID ==-1, then the suffix is just the graph
	 * @param ID
	 * @param prefix
	 * @param suffix
	 */
