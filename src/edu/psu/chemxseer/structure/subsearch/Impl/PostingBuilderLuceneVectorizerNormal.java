...
public class PostingBuilderLuceneVectorizerNormal implements PostingBuilderLuceneVectorizer {
	private IndexSearcherLucene searcher;
	private GraphParser gParser;
	
	public PostingBuilderLuceneVectorizerNormal(GraphParser gParser,IndexSearcherLucene searcher){
...
//		
//		Field subgraphField = new Field("subGraphs", termString, Field.Store.NO, Field.Index.ANALYZED_NO_NORMS);
