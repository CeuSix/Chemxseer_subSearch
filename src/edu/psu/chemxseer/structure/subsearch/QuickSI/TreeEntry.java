...
public class TreeEntry {
	...
	/**
	 * If the input "nodeString" is null, then entry will be assigned to be 5 "-1";
	 * @param labelEntry
	 */
	...
	public TreeEntry getNode(String nodeString){
		String[] parsed = nodeString.substring(1, nodeString.length()-1).split(" ");
	...
	/**
	 * Given the string representation of the Tree, construct its memory representation
	 * and return. The childrenID are returned throught the input parameter
	 * @param stringRep
	 * @param childrenID
	 * @return
	 */
