...
/**
 * This is an implementation of the Constrain QI Entry 
 * It can be either an extra edge constrain, where edgeDegree indicates the node that vk 
 * connected to.
 * or a degree constraint, where edgeDegree indicate the degree.
 * @author dayuyuan
 */
