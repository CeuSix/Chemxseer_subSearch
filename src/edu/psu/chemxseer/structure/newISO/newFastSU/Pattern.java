...
public class Pattern implements Comparable<Pattern>{
	...
	public Pattern(int fID, int queryInnerSupport, float dbInnerSupport, int fSize){
		this.fID = fID;
	...
	/**
	 * @param visitedEmbCount the visitedEmbCount to set
	 */
	public void increaseVisitedEmbCount() {
		this.visitedEmbCount++;
		// recauculate the score
		this.score = (this.queryInnerSupport-this.visitedEmbCount) * (this.dbInnerSupport - this.visitedEmbCount);
	}
