...
/**
 * A implementation of graph: containing both the Linked list and Matrix representation
 * of an object graph. 
 * To distinguish with Graph class in other resources, we name it as ISOGraph
 * Here we treat ISOGraph as the simplest symmetric and labeled undirected graph. 
 * For attributed graph, please refer to ISOAttrGraph
 * @author dayuyuan
 *
 */
public class ISOGraph {
	...
	/**
	 * Get edge label: e(node1, node2)
	 * Return -1 if e does not exist
	 * @param node1
	 * @param node2
	 * @return
	 */
	...
	/**
	 * Get the "index" th adjacent node of "nodeID"
